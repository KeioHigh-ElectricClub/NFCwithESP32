...
void loop() {
  ...
  if (strUID == UID01 || strUID == UID02 || strUID == UID03 || strUID == UID04 
      || strUID == UID05 || strUID == UID06 || strUID == UID07 || strUID == UID08
      || strUID == UID09 || strUID == UID10 || strUID == UID11 || strUID == UID12 
      || strUID == UID13 || strUID == UID14 || strUID == UID15 || strUID == UID16
      || strUID == UID17 || strUID == UID18 || strUID == UID19 || strUID == UID20 
      || strUID == UID21 || strUID == UID22 || strUID == UID23 || strUID == UID24
      || strUID == UID25 || strUID == UID26 || strUID == UID27 || strUID == UID28 
      || strUID == UID29 || strUID == UID30 || strUID == UID31 || strUID == UID32
      || strUID == UID33 || strUID == UID34 || strUID == UID35 || strUID == UID36 
      || strUID == UID37 || strUID == UID38 || strUID == UID39 || strUID == UID40) {
    display.clearDisplay();//一度初期化
...
void ESPserial(String strUID, byte MODEbyte, byte NUMBER,unsigned long* buffer) {
